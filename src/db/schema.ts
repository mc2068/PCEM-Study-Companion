...
export const lectureState = pgEnum("lecture_state", [
  "uploaded",
  "processing",
  "ready",
  "failed",
...
export const students = pgTable("students", {
  ...
  unique("students_email_key").on(t.email),
]);
...
export const modules = pgTable("modules", {
  ...
  check(
    "modules_semester_check",
    sql`${t.semester} IN ('P1S1', 'P1S2', 'P2S1', 'P2S2')`,
  ),
]);
...
export const examAttempts = pgTable("exam_attempts", {
  ...
  index("exam_attempts_student_started_idx").on(t.studentId, t.startedAt),
]);
...
export const examAttemptQuestions = pgTable("exam_attempt_questions", {
  ...
  unique("exam_attempt_questions_attempt_question_key").on(t.attemptId, t.questionId),
]);
...
export const usageEvents = pgTable("usage_events", {
  ...
  index("usage_events_student_created_idx").on(t.studentId, t.createdAt),
]);
...
export const chatMessages = pgTable("chat_messages", {
  ...
  index("chat_messages_lecture_created_idx").on(t.lectureId, t.createdAt),
]);
