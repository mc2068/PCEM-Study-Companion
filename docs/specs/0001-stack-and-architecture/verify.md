...
| 6   | Live deploy                                            | push to GitHub → import in Vercel                              | ✅                 | `pcem-study-companion.vercel.app` responds; anonymous requests redirect to the project's Clerk instance (auth wall, 200) — deployed and protected, 2026-09-07 |
